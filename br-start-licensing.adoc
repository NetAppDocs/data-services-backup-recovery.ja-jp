...
* NetApp Consoleでバックアップとリカバリを使用している場合は、従量課金制（PAYGO）ライセンスを契約するか、ライセンス持ち込み（BYOL）ライセンスを購入できます。
...
NetApp Backup and Recovery のライセンスを設定します。
...
=== マーケットプレイスライセンスまたはBYOLライセンスで年間契約を使用する
...
== NetApp Backup and Recovery のローカル展開のライセンスを設定する

オンプレミス バージョンの NetApp Console のライセンスを設定します。
...
BYOLライセンスを管理するには、NetApp Consoleのローカルデプロイを使用します。Consoleから、新しいライセンスの追加、既存のライセンスの更新、およびライセンスステータスの表示を行うことができます。
