...
* 保護グループを作成して、リソース セットのバックアップおよび復元操作を管理します。詳細については、link:br-use-hyperv-protection-groups.html["Hyper-V 保護グループを NetApp Backup and Recovery で作成および管理する"]を参照してください。
