...
[role="lead"]
サービスのリカバリや変更の適用が必要な場合は、Console エージェントホストから NetApp Backup and Recovery を再起動できます。デプロイメントの種類とコンテナランタイムに合ったコマンドを使用してください。

コンソール エージェントには、NetApp Backup and Recovery機能が含まれています。

.手順
. コンソールエージェントが実行されているLinuxシステムに接続します。
+
[cols="25,50"]
|===
| コンソールエージェントの場所 | 手順 
