...
[role="lead"]
リカバリ操作のために、制御された状態でデータベースにアクセスする必要がある場合は、Oracle Databaseのリカバリポイントをマウントしてください。自動カタログ作成が無効になっている場合は、RMANリカバリカタログにリカバリポイントのメタデータを手動でカタログ化できます。
...
== Oracle Databaseのリカバリポイントのアンマウント
...
== Oracle Databaseのリカバリポイントをカタログ化する
