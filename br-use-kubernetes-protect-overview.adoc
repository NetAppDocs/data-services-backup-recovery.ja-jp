...
---
= Kubernetesワークロードの管理について学ぶ NetApp Backup and Recovery
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
NetApp Backup and RecoveryでKubernetesワークロードを管理すると、Kubernetesクラスタとアプリケーションを1か所で検出、管理、保護できます。Kubernetesクラスタでホストされているリソースとアプリケーションを管理できます。また、単一のインターフェイスを使用して、Kubernetesアプリケーションの保護ポリシーを作成して関連付けることもできます。
