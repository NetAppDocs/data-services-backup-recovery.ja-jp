...
* 保護グループを作成して、リソース セットのバックアップおよび復元操作を管理します。link:br-use-kvm-protection-groups.html["NetApp Backup and Recoveryを使用したOracle Databaseワークロードの保護グループの作成と管理"]を参照してください。
